...
class ToolboxAI:
    ...
    def _build_system_prompt(self) -> str:
        ...
        return f"""You are a cybersecurity command-line expert for Kali Linux.
...
5. Use proper Kali Linux syntax and paths
6. Common wordlist path: /usr/share/wordlists/
...
Response: hydra -L /usr/share/wordlists/metasploit/unix_users.txt -P /usr/share/wordlists/rockyou.txt ssh://10.0.0.5
